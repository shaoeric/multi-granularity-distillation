...
print(f"CRD Teacher:{args.t_arch} => Student:{args.s_arch} [{exp_path}]")
...
for epoch in range(args.epoch):
    ...
    for img, target, index, contrast_idx in train_loader:
        ...
        logits_loss = args.ce_weight * F.cross_entropy(s_out, target) + args.kd_weight * criteon_kd(f_s, f_t, index, contrast_idx)
